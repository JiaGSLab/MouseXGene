...
class StrainLineUsageCountTests(TestCase):
    def setUp(self):
        ...
        self.other_strain = StrainLine.objects.create(line_name="OtherStrain", name="OtherStrain")
    ...
    def test_same_strain_pair_counts_one_active_breeding(self):
        ...
        line = self._annotated_line()
        self.assertEqual(line.active_breedings_count, 1)
        self.assertEqual(line.total_breedings_count, 1)
    ...
    def test_cage_counts_follow_breeder_current_cage(self):
        ...
        line = self._annotated_line()
        self.assertEqual(line.active_cages_count, 2)
        self.assertEqual(line.total_cages_count, 2)
