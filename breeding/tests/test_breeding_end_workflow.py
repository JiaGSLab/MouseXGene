...
class BreedingEndWorkflowTests(TestCase):
    ...
    def test_end_page_requires_breeder_destinations(self):
        ...
        self.assertContains(response, "Every breeder must have an outcome")
        self.assertContains(response, "Destination Cages For Moved Breeders")
        self.assertContains(response, "Mark all euthanized")
        self.assertContains(response, "Move all to cages")
